...
#ifndef POLARBLESDKWATCHOS_SWIFT_H
#define POLARBLESDKWATCHOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PolarBleSdkWatchOs",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC18PolarBleSdkWatchOs16BleDeviceSession")
@interface BleDeviceSession : NSObject
...
SWIFT_CLASS("_TtC18PolarBleSdkWatchOs20CBDeviceListenerImpl")
@interface CBDeviceListenerImpl : NSObject <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC18PolarBleSdkWatchOs19CBDeviceSessionImpl")
@interface CBDeviceSessionImpl : BleDeviceSession <CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC18PolarBleSdkWatchOs15PolarBleApiImpl")
@interface PolarBleApiImpl : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
